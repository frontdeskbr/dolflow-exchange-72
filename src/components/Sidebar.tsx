        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* Menu Item Dashboard */}
              <li>
                <a className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 bg-graydark dark:bg-meta-4" href="index.html">
              ...
              {/* Menu Item Profile */}
              <li>
                <a className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="profile.html">
                  <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Menu Item Tables */}
              <li>
                <a className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="basic-tables.html">
                  <svg className="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.7499 0.975098H2.2499C1.29365 0.975098 0.478027 1.7626 0.478027 2.72473V15.5059C0.478027 16.4681 1.26553 17.2556 2.2499 17.2556H15.7499C16.7062 17.2556 17.5218 16.4681 17.5218 15.5059V2.72473C17.5218 1.7626 16.7062 0.975098 15.7499 0.975098ZM6.08115 15.8025H2.2499C1.99678 15.8025 1.77178 15.5775 1.77178 15.3244V13.0181H6.08115V15.8025ZM6.08115 11.7244H1.77178V8.17473H6.08115V11.7244ZM6.08115 6.8806H1.77178V4.57435H6.08115V6.8806ZM6.08115 3.2806H1.77178V2.72473C1.77178 2.47161 1.99678 2.24661 2.2499 2.24661H6.08115V3.2806ZM16.2562 15.3244C16.2562 15.5775 16.0312 15.8025 15.7781 15.8025H7.37178V13.0181H16.2562V15.3244ZM16.2562 11.7244H7.37178V8.17473H16.2562V11.7244ZM16.2562 6.8806H7.37178V4.57435H16.2562V6.8806ZM16.2562 3.2806H7.37178V2.24661H15.7499C16.0031 2.24661 16.228 2.47161 16.228 2.72473V3.2806H16.2562Z"/>
                  </svg>
                  Tables
                </a>
              </li>
